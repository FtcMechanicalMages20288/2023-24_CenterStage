...
@TeleOp(name = "MecDriveSingStick8D", group = "TeleOp")
@Disabled
public class MecDriveSingSt8D extends OpMode {
...
*/
    ...
    public void loop() {
        ...
        if (Color instanceof DistanceSensor) {
            ...
            //Movement Controller
        if (gamepad1.left_stick_x < 0 || gamepad1.left_stick_x > 0 && gamepad1.left_stick_y < 0 || gamepad1.left_stick_y > 0) { //Movement Controller
        ...
        } else if (gamepad1.left_stick_x < 0 || gamepad1.left_stick_x > 0 && gamepad1.left_stick_y < 0 || gamepad1.left_stick_y > 0) {
            left_drivePower = gamepad1.left_stick_x; // left drive is 0
            right_drivePower = -gamepad1.left_stick_x; // right drive is 2
            back_left_drivePower = -gamepad1.left_stick_x; // back left drive is 1
            back_right_drivePower = gamepad1.left_stick_x; // back right drive is 3
        }
