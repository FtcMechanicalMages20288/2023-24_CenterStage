...
public class Board2Pixel extends LinearOpMode {
    ...
    private Servo BucketHold, BucketR, BucketL,  Grabber;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence boardtostack = drive.trajectorySequenceBuilder(sP)
                .strafeRight(18)
                .lineToConstantHeading(new Vector2d(-90,-15))
                .strafeLeft(7)
