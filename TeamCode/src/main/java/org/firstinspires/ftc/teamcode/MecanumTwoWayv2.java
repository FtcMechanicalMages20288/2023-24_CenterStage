...
*/
    ...
    public void loop() {
        ...
        if (slow) {
            ...
            left_drive.setPower(left_drivePower * -0.4);
            right_drive.setPower(right_drivePower * -0.4);
            back_left_drive.setPower(left_drivePower * -0.4);
            back_right_drive.setPower(right_drivePower * -0.4);
