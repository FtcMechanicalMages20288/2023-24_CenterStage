...
{
    final double SAFE_DRIVE_SPEED   = 0.2 ; // Adjust this to your robot and your driver.  Slower usually means more accuracy.  Max value = 1.0
    final double SAFE_STRAFE_SPEED  = 0.2 ; // Adjust this to your robot and your driver.  Slower usually means more accuracy.  Max value = 1.0
    final double SAFE_YAW_SPEED     = 0.2 ; // Adjust this to your robot and your driver.  Slower usually means more accuracy.  Max value = 1.0
    ...
    @Override public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.addData("before drive D:S:Y", "%5.2f %5.2f %5.2f", drive, strafe, yaw);
