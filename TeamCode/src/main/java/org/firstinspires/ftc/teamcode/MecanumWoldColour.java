...
@TeleOp(name = "MecanumWWColour", group = "TeleOp")


public class MecanumWoldColour extends LinearOpMode {
    ...
    private ColorSensor PixColor, PixColorFront;
    ...
    private void FinalColor(String Color1) {

    }

    private void YellowPixIn() {
        if((200 < PixColorFront.red() && PixColorFront.red() < 300 )
                && ( 100 < PixColorFront.blue()  ) && ( PixColorFront.blue() < 200 )
                && (360 <  PixColorFront.green())  &&(  PixColorFront.green() < 480 )
                && Pixels == 2){
    ...
    private void GreenPixIn() {
        if( (20 < PixColorFront.red() && PixColorFront.red() < 130 )
                && ( 100 < PixColorFront.blue() ) && ( PixColorFront.blue() < 200 )
                && (150 < PixColorFront.green()) && ( PixColorFront.green() < 240 )
                && Pixels == 2){
    ...
    private void PurplePixIn() {
        if( (200 < PixColorFront.red() && PixColorFront.red() < 300 )
                && ( 430 < PixColorFront.blue()  ) && ( PixColorFront.blue() < 530 )
                && (310 <  PixColorFront.green())  &&(  PixColorFront.green() < 400 )
                && Pixels == 2){
    ...
    private void WhitePixIn() {
        if( (420 < PixColorFront.red() && PixColorFront.red() < 520 )
                && ( 650 < PixColorFront.blue()  ) && ( PixColorFront.blue() < 768 )
                && (720 <  PixColorFront.green())  &&(  PixColorFront.green() < 820 )
                && Pixels == 2){
    ...
    private void initCode(){
        ...
        PixColor = hardwareMap.get(ColorSensor.class,"Color");
        PixColorFront = hardwareMap.get(ColorSensor.class,"Color2");
