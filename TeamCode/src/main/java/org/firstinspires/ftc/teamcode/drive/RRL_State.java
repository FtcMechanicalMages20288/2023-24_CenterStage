...
public class RRL_State extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence pos1_deposit = drive.trajectorySequenceBuilder(pos1_intake.end())
                ...
                .lineToConstantHeading(new Vector2d(42, -72))//Dhruv Pos3 Already(Changed the X value so it lands Pos2)
        ...
        TrajectorySequence pos2 = drive.trajectorySequenceBuilder(sP)
                ...
                .lineToLinearHeading(new Pose2d(25, 15.5, Math.toRadians(88))) //Dhruv Change
