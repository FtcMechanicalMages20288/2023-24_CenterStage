...
public class RRR_WorldPlus2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence pos1 = drive.trajectorySequenceBuilder(sP)
                ...
                .lineToLinearHeading(new Pose2d(30.5,-23,Math.toRadians(-90)))
        ...
        TrajectorySequence traj4 = drive.trajectorySequenceBuilder(traj2.end())
                ...
                .lineToLinearHeading(new Pose2d(3.65,-8,Math.toRadians(-91.5))) //x = 4.5 prev
                .lineToLinearHeading(new Pose2d(3.65, 58, Math.toRadians(-91.5))) //x = 4.5 prev
                .lineToLinearHeading(new Pose2d(16.5,65, Math.toRadians(-90-33)))
...
//                .lineToLinearHeading(new Pose2d(strafetox+5,strafetoy,Math.toRadians(90)))
                ...
                .lineToLinearHeading(new Pose2d(3.65, 60, Math.toRadians(-91.5))) //x = 4.5 prev
                .lineToLinearHeading(new Pose2d(3.65,-8,Math.toRadians(-91.5))) //x = 4.5 prev
...
//                .forward(6)
        ...
        TrajectorySequence pos3 = drive.trajectorySequenceBuilder(sP)
                ...
                .lineToLinearHeading(new Pose2d(x22Value-2,-y22Value,Math.toRadians(-90))) //prev x 0.5
        ...
        TrajectorySequence tempPark2 = drive.trajectorySequenceBuilder(traj2_2.end())
                .back(5)
                .lineToLinearHeading(new Pose2d(strafetox,-33,Math.toRadians(-90)))
                .build();
            ...
            if(finalDropPos == 1 ) {
                ...
                while (!pixelCheck) {
                    ...
                    if (!(((DistanceSensor) Color).getDistance(DistanceUnit.CM) < 2) &&
                        ...
                        pixelCheck = true;
                        telemetry.addData("check", "Krrish sucks");
                        telemetry.update();
                    }
                }
                IntakeRoller.setPower(0);
